...
//  extern uint8_t* zcl_buffer_uint32( uint8_t *buf, uint32 val );
...
//  extern uint32 zcl_build_uint32( uint8_t *swapped, uint8_t len );
...
// */
//extern ZStatus_t zcl_registerAttrList( uint8_t endpoint, uint8_t numAttr, CONST zclAttrRec_t attrList[] );
//
///*
...
// */
//extern ZStatus_t zcl_SendCommand( uint8_t srcEP, afAddrType_t *dstAddr,
...
// */
//extern ZStatus_t zcl_SendConfigReportRspCmd( uint8_t srcEP, afAddrType_t *dstAddr,
...
// */
//extern ZStatus_t zcl_SendReadReportCfgRspCmd( uint8_t srcEP, afAddrType_t *dstAddr,
...
// */
//extern ZStatus_t zcl_SendReportCmd( uint8_t srcEP, afAddrType_t *dstAddr,
...
// */
//extern uint8_t zcl_getParsedTransSeqNum( void );
